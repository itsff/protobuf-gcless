...
public class TestRequiredImpl implements protobuf_memless_unittest.UnittestProto.TestRequired {
private int A;
...
private protobuf_memless_unittest.UnittestProto.TestRequired Single;
private boolean hasSingle;
public boolean hasSingle() {
return hasSingle;
}
public protobuf_memless_unittest.UnittestProto.TestRequired getSingle() {
return Single;
}
public void setSingle(protobuf_memless_unittest.UnittestProto.TestRequired Single) {
this.Single = Single;
this.hasSingle = true;
}
private java.util.List<protobuf_memless_unittest.UnittestProto.TestRequired> Multi;
private boolean hasMulti;
public boolean hasMulti() {
return hasMulti;
}
public java.util.List<protobuf_memless_unittest.UnittestProto.TestRequired> getMulti() {
return Multi;
}
public void setMulti(java.util.List<protobuf_memless_unittest.UnittestProto.TestRequired> Multi) {
this.Multi = Multi;
this.hasMulti = true;
}
private int Dummy4;
