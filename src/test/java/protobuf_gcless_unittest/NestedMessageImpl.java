...
public class NestedMessageImpl implements protobuf_gcless_unittest.UnittestProto.TestNestedMessageHasBits.NestedMessage {
...
private java.util.List<protobuf_gcless_unittest.UnittestProto.ForeignMessage> Nestedmessage_repeated_foreignmessage;
...
public java.util.List<protobuf_gcless_unittest.UnittestProto.ForeignMessage> getNestedmessage_repeated_foreignmessage() {
return Nestedmessage_repeated_foreignmessage;
}
public void setNestedmessage_repeated_foreignmessage(java.util.List<protobuf_gcless_unittest.UnittestProto.ForeignMessage> Nestedmessage_repeated_foreignmessage) {
