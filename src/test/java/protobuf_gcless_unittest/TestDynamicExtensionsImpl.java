...
public class TestDynamicExtensionsImpl implements protobuf_gcless_unittest.UnittestProto.TestDynamicExtensions {
...
private protobuf_gcless_unittest.UnittestProto.ForeignEnum Enum_extension;
private boolean hasEnum_extension;
public boolean hasEnum_extension() {
return hasEnum_extension;
}
public protobuf_gcless_unittest.UnittestProto.ForeignEnum getEnum_extension() {
return Enum_extension;
}
public void setEnum_extension(protobuf_gcless_unittest.UnittestProto.ForeignEnum Enum_extension) {
this.Enum_extension = Enum_extension;
this.hasEnum_extension = true;
}
private protobuf_gcless_unittest.UnittestProto.TestDynamicExtensions.DynamicEnumType Dynamic_enum_extension;
private boolean hasDynamic_enum_extension;
public boolean hasDynamic_enum_extension() {
return hasDynamic_enum_extension;
}
public protobuf_gcless_unittest.UnittestProto.TestDynamicExtensions.DynamicEnumType getDynamic_enum_extension() {
return Dynamic_enum_extension;
}
public void setDynamic_enum_extension(protobuf_gcless_unittest.UnittestProto.TestDynamicExtensions.DynamicEnumType Dynamic_enum_extension) {
this.Dynamic_enum_extension = Dynamic_enum_extension;
this.hasDynamic_enum_extension = true;
}
private protobuf_gcless_unittest.UnittestProto.ForeignMessage Message_extension;
private boolean hasMessage_extension;
public boolean hasMessage_extension() {
return hasMessage_extension;
}
public protobuf_gcless_unittest.UnittestProto.ForeignMessage getMessage_extension() {
return Message_extension;
}
public void setMessage_extension(protobuf_gcless_unittest.UnittestProto.ForeignMessage Message_extension) {
this.Message_extension = Message_extension;
this.hasMessage_extension = true;
}
private protobuf_gcless_unittest.UnittestProto.TestDynamicExtensions.DynamicMessageType Dynamic_message_extension;
...
public protobuf_gcless_unittest.UnittestProto.TestDynamicExtensions.DynamicMessageType getDynamic_message_extension() {
return Dynamic_message_extension;
}
public void setDynamic_message_extension(protobuf_gcless_unittest.UnittestProto.TestDynamicExtensions.DynamicMessageType Dynamic_message_extension) {
